...
# Determine positions
x1 = 0
x2 = radius1 + radius2 - input_overlap_radius
y = 0
...
def draw_orbitals(ax, x_center, y_center, element, color):
    ...
    for orbital, fraction_range in orbitals.items():
        if orbital in orbital_distances:
            ...
            circle = plt.Circle((x_center, y_center), outer, color=color, fill=False, linestyle='-', alpha=0.5)
...
ax.set_title(f"Visualization of {input_bond} bond with orbitals")
