...
for item_orl in overlap_radius_list:
    for key_orl, R in item_orl.items():
        ...
        orbitals_participating_1 = [orb for orb in orbital_ele1 if orbital_distances[orb][1] >= D1]
        orbitals_participating_2 = [orb for orb in orbital_ele2 if orbital_distances[orb][1] >= D2]
