...
covalent_radii = {'H': 37, 'He': 31, 'Li': 128, 'Be': 96, 'B': 84, 'C': 77, 'N': 75, 'O': 73, 'F': 71, 'Ne': 38,
                  'Na': 130, 'Mg': 141, 'Al': 121, 'Si': 111, 'P': 110, 'S': 104, 'Cl': 99, 'Ar': 71, 'K': 203, 'Ca': 176,
                  'Sc': 162, 'Ti': 146, 'V': 134, 'Cr': 139, 'Mn': 139, 'Fe': 140, 'Co': 125, 'Ni': 124, 'Cu': 110, 'Zn': 139,
                  'Ga': 122, 'Ge': 122, 'As': 119, 'Se': 116, 'Br': 114, 'Kr': 88, 'Rb': 210, 'Sr': 191, 'Y': 177, 'Zr': 160,
                  'Nb': 146, 'Mo': 139, 'Tc': 138, 'Ru': 139, 'Rh': 137, 'Pd': 139, 'Ag': 127, 'Cd': 144, 'In': 144, 'Sn': 141,
                  'Sb': 139, 'I': 133, 'Te': 138, 'Xe': 108, 'Cs': 224, 'Ba': 244, 'La': 195, 'Ce': 198, 'Pr': 200, 'Nd': 200,
                  'Pm': 202, 'Sm': 203, 'Eu': 206, 'Gd': 207, 'Tb': 208, 'Dy': 209, 'Ho': 210, 'Er': 211, 'Tm': 212, 'Yb': 214,
                  'Lu': 215, 'Hf': 159, 'Ta': 146, 'W': 139, 'Re': 137, 'Os': 136, 'Ir': 135, 'Pt': 139, 'Au': 127, 'Hg': 150,
                  'Tl': 146, 'Pb': 154, 'Bi': 157, 'Po': 150, 'At': 150, 'Rn': 140, 'Fr': 210, 'Ra': 210, 'Ac': 205, 'Th': 206,
                  'Pa': 200, 'U': 138, 'Np': 190, 'Pu': 186, 'Am': 184, 'Cm': 183, 'Bk': 182, 'Cf': 181, 'Es': 180, 'Fm': 179,
...
for bond in bond_length_list:
    for key_bond, value_bond in bond.items():
        ...
        if converted_bond_length < 2 * (era + ern):
            R_overlap_radius = (era + ern) - converted_bond_length  # Calculates the Radius of the overlap
            Delta = math.sqrt((-converted_bond_length + era + ern) * (converted_bond_length + era - ern) * (converted_bond_length - era + ern) * (converted_bond_length + era + ern))
            Roa = (era ** 2 * math.acos((converted_bond_length ** 2 + era ** 2 - ern ** 2) / (2 * converted_bond_length * era)) + ern ** 2 * math.acos((converted_bond_length ** 2 + ern ** 2 - era ** 2) / (2 * converted_bond_length * ern)) - 0.5 * Delta)  # Calculates the Area of the overlap
            Rov = (math.pi * (era + ern - converted_bond_length) ** 2 * (converted_bond_length ** 2 + 2 * converted_bond_length * (era + ern) - 3 * (era - ern) ** 2)) / (12 * converted_bond_length)  # Calculates the volume of the overlap
